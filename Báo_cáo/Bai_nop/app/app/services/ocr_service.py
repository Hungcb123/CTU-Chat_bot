...
async def main():
    ...
    try:
        folder_path = Path(os.path.join(PROJECT_ROOT, "data", "input"))
        output_dir = Path(os.path.join(PROJECT_ROOT, "data", "markdown"))
        ...
        async def process_file(file):
            try:
                ...
                done_dir = Path(os.path.join(PROJECT_ROOT, "data", "done"))
