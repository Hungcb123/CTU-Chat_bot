...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # LLM phụ (đời cũ, gọn nhẹ) chỉ chuyên dùng để viết lại câu hỏi cho tiết kiệm
        app.state.rewrite_llm = ChatGoogleGenerativeAI(model="gemini-2.5-flash-lite", temperature=0.1)
...
if __name__ == "__main__":
    ...
    uvicorn.run("UI.new_app:app", host="0.0.0.0", port=8000, reload=True)