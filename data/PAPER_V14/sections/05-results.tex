...
On the 20 cross-domain queries, \system{} achieves an 80.0\% pass rate (vs.\ 70.0\% Single, 65.0\% Generic). Threshold sensitivity confirms stability: \system{} leads significantly at $\theta \in \{0.40, 0.50\}$ (+10.0\,pp, exact McNemar $p{=}0.0414$, 95\% CI $[+1.0, +19.0]$\,pp) and leads at $\theta{=}0.60$ (54.0\% vs.\ 50.0\%). At $\theta \ge 0.70$, pass rates compress across architectures; Single Agent's nominal 2--3 query advantage (e.g., 30.0\% vs.\ 27.0\% at $\theta{=}0.75$) is statistically indistinguishable from noise (McNemar $p{=}0.5488$, 95\% CI $[-10.0, +3.0]$\,pp).
