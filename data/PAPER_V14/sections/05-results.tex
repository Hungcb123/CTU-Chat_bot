...
On the 20 cross-domain queries, \system{} achieves an 80.0\% pass rate (vs.\ 70.0\% Single, 65.0\% Generic). Evaluating sensitivity across thresholds, at the 50\% fact-coverage threshold, \system{} achieved a higher automated pass rate than Single Agent (76.0\% vs.\ 66.0\%; unadjusted exact McNemar $p{=}0.0414$, 95\% CI $[+1.0, +19.0]$\,pp). The observed difference narrowed at 60\% (54.0\% vs.\ 50.0\%) and reversed at stricter thresholds (e.g., 27.0\% vs.\ 30.0\% at 75\%). The difference at 75\% was uncertain ($p{=}0.5488$, 95\% CI $[-10.0, +3.0]$\,pp); these results do not establish an advantage for either architecture at stricter thresholds.
