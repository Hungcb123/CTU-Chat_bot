...
This analysis exposes three operational gaps in automated university counseling: (1)~\emph{Lack of bounded multi-agent orchestration}: monolithic pipelines and unconstrained agent meshes lack execution guardrails, frequently triggering tool mis-selection and parameter hallucination; (2)~\emph{Limitations of uniform representation}: forcing relational curricula, tabular tuition matrices, and narrative legal text into a single retrieval space can cause prerequisite fragmentation and semantic drift; and (3)~\emph{Absence of representation-aware routing}: dynamic steering mechanisms that allocate queries across isolated representation pathways while offloading statutory arithmetic to deterministic engines remain largely unaddressed in higher-education administrative counseling. These structural gaps motivate the centralized supervisor-routed architecture detailed in Section~3.
