...
\begin{itemize}
    ...
    \item \textbf{RQ2:} What are the individual contributions of specialist policies, tool isolation, heterogeneous evidence, deterministic computation, and route repair?
...
\textbf{C2}---an architecture-level comparative evaluation against a functionally matched single-agent baseline and a routed generic-worker variant;
