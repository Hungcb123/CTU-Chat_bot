...
\begin{itemize}
    ...
    How does intent-guided selection of representation-specific evidence paths affect retrieval effectiveness and answer accuracy across different counseling domains?
\end{itemize}
