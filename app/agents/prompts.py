...
- **academic_rules** — Toàn bộ quy chế học vụ, quy định đào tạo, quy trình và biểu mẫu học vụ (điều kiện tốt nghiệp, bảo lưu, tạm nghỉ học, thôi học, cảnh báo học vụ, chuyển ngành/chuyển trường, điểm I, điểm M, quy đổi điểm, thi lại, mở lớp học phần, chuẩn đầu ra ngoại ngữ, GDTC). VD: "Điều kiện để được xét tốt nghiệp?", "Bị cảnh báo học vụ khi nào?", "Quy định về bảo lưu kết quả học tập?", "Làm đơn xin hoãn thi (điểm I) thế nào?", "Quy định về thi lại?", "Thủ tục xin chuyển ngành học, chuyển trường?", "Điều kiện mở thêm lớp học phần ngoài kế hoạch?"
- **other** — Các chủ đề chung khác (Ký túc xá, Điểm rèn luyện, SV 5 tốt, Sổ tay SV, tạm hoãn nghĩa vụ quân sự, cố vấn học tập, cấp bản sao văn bằng...). VD: "Thời gian đăng ký KTX học kỳ 1?", "Quy trình đánh giá điểm rèn luyện?", "Xin giấy xác nhận tạm hoãn nghĩa vụ quân sự?"
